      ...
      <section className="relative overflow-hidden py-10 sm:py-14">
        ...
        <div className="container relative">
          <div className="grid gap-6 lg:grid-cols-[1.1fr_.9fr]">
            <section className="relative overflow-hidden rounded-[32px] border border-white/70 bg-white/90 p-6 shadow-[0_24px_80px_rgba(15,23,42,0.08)] backdrop-blur-sm sm:p-8 lg:p-10">
              ...
              <p className="mt-4 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
                هذه هي الخطوة الأخيرة قبل الانتقال إلى صفحة الدفع. راجع تفاصيل
                الخطة، الفوترة، وأهم المزايا حتى تكمل العملية وأنت مطمئن.
              </p>
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-3">
                ...
                <div className="rounded-[24px] border border-slate-200 bg-slate-50 p-4">
                  ...
                  <div className="mt-2 text-lg font-extrabold text-slate-950">{plan.subtitle}</div>
                </div>
              </div>
              ...
              <div className="mt-8 rounded-[28px] border border-emerald-100 bg-emerald-50/80 p-5 sm:p-6">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div>
                    <h2 className="text-2xl font-black text-slate-950">ما الذي ستحصل عليه</h2>
            ...
            <aside className="space-y-6">
              <section className="relative overflow-hidden rounded-[32px] bg-[linear-gradient(160deg,#0b1320_0%,#0f172a_45%,#0f766e_100%)] p-6 text-white shadow-[0_26px_70px_rgba(15,23,42,0.2)] sm:p-7">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.14),transparent_30%),radial-gradient(circle_at_bottom_right,rgba(52,211,153,0.24),transparent_38%)]" />
                ...
                <div className="relative">
                  ...
                  <div className="mt-5 rounded-[28px] border border-white/10 bg-white/10 p-5 backdrop-blur">
                    ...
                    <div className="mt-3 text-3xl font-black">{plan.name}</div>
