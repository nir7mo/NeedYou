      ...
      <section className="how" id="how">
        <div className="container">
          <div className="section-head">
            ...
            <h2>أربع خطوات بسيطة تبدأ بها الآن</h2>
            <p>تجربة سلسة تبدأ من إدخال بياناتك وتنتهي بملف مهني جاهز للاستخدام.</p>
          </div>
          ...
          <div className="steps">
            <div className="step">
              ...
              <h3>سجّل حسابك</h3>
              <p>ابدأ بإعداد حسابك وإدخال بياناتك الأساسية بسهولة.</p>
            </div>
            <div className="step">
              <div className="step-num">2</div>
              <h3>أضف معلوماتك</h3>
              <p>املأ بيانات الخبرات، التعليم، والمهارات بسرعة.</p>
            </div>
            <div className="step">
              <div className="step-num">3</div>
              <h3>اختر الخدمة</h3>
              <p>حدد خدمة إنشاء السيرة أو الرسالة أو تحليل الوظيفة.</p>
            </div>
            <div className="step">
              <div className="step-num">4</div>
              <h3>تحميل ومشاركة</h3>
              <p>احصل على ملفاتك بصيغة PDF أو Word بجودة عالية.</p>
            </div>
          </div>
        </div>
      </section>
