...
export const translations: Record<Language, Translations> = {
  ar: {
    ...
    pricing: {
      ...
      description: "خطط واضحة تناسب الاستخدام الشخصي أو التجاري.",
      plans: [
        {
          name: "مجاني",
          subtitle: "للبدء فقط",
          ...
          features: [
            ...
            "تحليل أساسي فقط",
            "قالب أساسي فقط",
            "تحميل واحد فقط كل أسبوع",
            "محاولة واحدة أسبوعيا",
          ],
          note: "نسخة تجريبية محدودة للاستخدام الشخصي",
          cta: "ابدأ مجانا",
          tone: "secondary",
        },
        {
          ...
          features: [
            ...
            "تحسين توافق ATS",
            "تحليل الوظائف",
            "تحليل متطلبات المنصب",
            "مقارنة متطلبات الوظيفة مع مهارات وقدرات المترشح",
            "اقتراح أفضل نموذج سيرة ذاتية مناسب للوظيفة",
            "استخدام كامل لكل ميزات التقديم للوظائف",
          ],
          note: "هذه الخطة مخصصة لشخص واحد فقط ولا يمكن استخدامها لعدة مرشحين",
          cta: "اشترك الآن",
        ...
        {
          name: "الشريك",
          subtitle: "للاستخدام التجاري وإدارة عدة مرشحين",
          price: "20€",
          period: "شهريا",
          features: [
            "استخدام غير محدود",
            "إدارة عدة ملفات شخصية",
            "إنشاء سير ذاتية لعدة مرشحين",
            "تحليل وظائف غير محدود",
            "رسائل تحفيزية غير محدودة",
            "استخدام تجاري كامل",
            "تصدير ملفات العملاء",
            "العمل كمستقل أو مقدم خدمة",
            "الوصول الكامل لكل ميزات المنصة بدون قيود",
          ],
          note: "للاستخدام التجاري",
          cta: "انضم كشريك",
          tone: "business",
        },
      ],
  ...
  fr: {
    ...
    pricing: {
      ...
      description: "Des offres claires pour usage personnel ou commercial.",
      plans: [
        {
          name: "Gratuit",
          ...
          note: "Essai limité pour usage personnel",
          cta: "Commencer",
          tone: "secondary",
        },
        {
          ...
          features: [
            ...
            "Comparaison des compétences avec le poste",
            "Suggestion du meilleur modèle adapté",
  ...
  en: {
    ...
    pricing: {
      ...
      description: "Clear plans for personal or commercial use.",
      plans: [
        {
          name: "Free",
          ...
          note: "Limited trial for personal use",
          cta: "Start Free",
          tone: "secondary",
        },
        {
          ...
          features: [
            ...
            "Suggest the best CV template for the role",
